"""
Django settings for proyecto_seguro project.
...
SECRET_KEY = 'django-insecure-+wnidqutgk&sf%+edtib()rpo3#m)dtpql1^6b=!t_tz=nukg^'
...
ROOT_URLCONF = 'proyecto_seguro.urls'
...
# Para desarrollo
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # Opcional: si tienes static a nivel proyecto
]
